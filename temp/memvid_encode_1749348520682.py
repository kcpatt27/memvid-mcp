...
try:
    ...
    all_files = []
    sources = [{"type":"text","path":"This is test content for the fixed memory bank execution."}]
    ...
    output_path = r"D:\\projects\\personal-projects\\memvid-mcp\\memory-banks\\fixed-test-1749348520657.mp4"
