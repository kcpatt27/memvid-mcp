...
try:
    bank_path = r"D:\\projects\\personal-projects\\memvid-mcp\\memory-banks\\search_benchmark_1749403584508.mp4"
    index_path = bank_path.replace('.mp4', '.faiss')
    retriever = MemvidRetriever(bank_path, index_path)
    query = "computer vision natural language processing optimization techniques"
