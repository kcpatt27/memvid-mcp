...
try:
    ...
    all_files = []
    sources = [{"type":"directory","path":"./test-data-direct","options":{"file_types":[".md",".ts",".js",".txt"]}}]
    ...
    output_path = r"D:\\projects\\personal-projects\\memvid-mcp\\memory-banks\\direct-test.mp4"
