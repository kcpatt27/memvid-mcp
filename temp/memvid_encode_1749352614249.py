...
try:
    ...
    all_files = []
    sources = [{"type":"text","path":"This is a test memory bank creation. It should work correctly now that we fixed the MCP communication issue. The server is responding to requests properly."}]
    ...
    output_path = r"D:\\projects\\personal-projects\\memvid-mcp\\memory-banks\\test-working-1749352614227.mp4"
