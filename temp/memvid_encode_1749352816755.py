...
try:
    ...
    all_files = []
    sources = [{"type":"text","path":"SUCCESS! The MemVid MCP server is now fully operational."}]
    ...
    output_path = r"D:\\projects\\personal-projects\\memvid-mcp\\memory-banks\\final-test-1749352816735.mp4"
